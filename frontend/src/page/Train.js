...
export default function Train() {
  ...
  return (
    <div className="flex flex-col w-auto h-full bg-gradient-to-tl from-[#5748B9] to-[#624F77] m-6 mx-8 rounded-3xl p-7 px-16 overflow-hidden">
      {state === 0 && <TrainUpload handleState={handleState} />}
      {isMutatingTrain ? <TrainLoading /> : null}
      {state !== 0 && !isMutatingTrain && <TrainComplete />}
