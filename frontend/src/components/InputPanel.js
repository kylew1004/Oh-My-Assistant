...
export default function InputPanel({imageUrl, isFetching, handleChange, handleSubmit, handlePromptChange, prompt, cancelChange}){

    return  <div className="flex flex-col w-full h-full my-auto relative shadow-xl bg-white bg-opacity-90  border-#7264a9 rounded-3xl p-5 py-4 mx-3">
