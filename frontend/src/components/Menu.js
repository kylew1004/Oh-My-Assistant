...
export default function Menu() {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-bl from-[#0f0417] to-[#24263d] h-screen w-[220px] float-left overflow-hidden">
      ...
      <div className="flex flex-col py-4 h-2/3">
        ...
        <button
          className="text-yellow-500 text-md pb-1 bg-transparent text-left mt-3 mx-auto"
          onClick={handleClick}
        >
          + Add New Webtoon
        </button>
      ...
      <Form action="/logout" method="post" className="flex flex-col h-full">
        <button className="mt-auto text-gray-900 text-lg mb-4 bg-gray-300 rounded-full h-[47px] w-10/12 mx-auto">
          Log out
        </button>
      </Form>
    </div>
