...
export default function AssetDetail(){
    ...
    <div className="flex flex-col h-full w-full bg-white rounded-l-xl p-5 justify-between">
        <span className=" h-[90%] flex border rounded-lg p-3 bg-violet-300 bg-opacity-20 justify-center items-center object-contain mx-auto" >
    ...
    <div className="h-full w-full bg-white rounded-r-xl flex flex-col p-5">
    DETAILS
    </div>
    </div>;
}
