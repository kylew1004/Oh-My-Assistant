...
export default function AssetDetail(){
    const [activeImage, setActiveImage] = useState(urls[0]);
    ...
    <div className="flex flex-col h-full w-full rounded-l-xl p-2 justify-between">
        <span className=" h-[90%] flex rounded-lg p-3 bg-violet-300 bg-opacity-60 justify-center items-center object-contain mx-auto" >
    ...
    <div className="h-full w-full rounded-r-xl flex flex-col mx-auto gap-3 overflow-auto">
        ...
        <div className="flex flex-col w-full mx-auto bg-violet-300 bg-opacity-30 rounded-lg itemes-center justify-center gap-2">
            ...
            <img className="rounded-md" src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" />
        </div>
...
export function loader({params, request}){
    ...
    if(searchTerm=='Scenes') return defer({
        mode:searchTerm,
        assets: getStyleAlbum(data),
      });

    return defer({
        mode:searchTerm,
        assets: getPoseAlbum(data),
      })
}