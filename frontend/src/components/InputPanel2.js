...
export default function InputPanel({imageUrl, isFetching, handleChange, handleSubmit}){
    ...
    return  <div className="flex flex-row shadow-xl bg-white bg-opacity-90 rounded-3xl w-full h-full">
        <div className="w-full h-full flex flex-col my-auto relative shadow-xl bg-white bg-opacity-90  border-#7264a9 rounded-3xl p-5 py-4 mx-3">
