...
export default function CreateNewPanel({type, detail, link, img, disable}){
    ...
    return <NavLink to={link} onClick={disable ? e=>e.preventDefault() : (e)=>{}} className={`flex flex-col h-auto w-2/5 m-auto my-16 ${disable ? 'bg-gray-400 cursor-auto hover:cursor-auto' : 'bg-yellow-500'} rounded-3xl overflow-hidden py-5 pt-16`}>
