...
export default function Panel(){
    return <div className="flex flex-row bg-gray-100 h-[130px] w-full ">
    <div className="flex flex-col pl-3">
        <h1 className="text-gray-800ß text-4xl my-auto ml-5 font-bold mb-0" >목욕의 신</h1>
    ...
    <NavLink to="/train" className="ml-auto my-auto mr-12 rounded-full text-white h-1/2 px-8
